        	 ...
        	 <div class="limiter visible-desktop">
               <label>Show</label>
                  <select>
					...
					<ul>
					  <li>
							<a class="cbp-vm-image" href="red.jsp">
							 <div class="view view-first">
								...
								<div class="product_image">
									...
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Lorem Ipsum Red</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="white.jsp">
							  <div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									...
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Lorem Ipsum White</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="black.jsp">
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									...
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Lorem Ipsum  Black</p>
									   </div>
									   <div class="price">$80.00</div>
									   <div class="clearfix"></div>
								     </div>		
			...
			<div class="container">
				...
				<div class="footer-grid">
				 ...
				 <div class="footer-grid footer-grid_last">
                    ...
                    <p class="email">Email: &nbsp;&nbsp;&nbsp;<span>info@Surfhouse.com</span></p>	
                 </div>
				 <div class="clearfix"> </div>
			</div>
		</div>
		...
		<div class="header-top">
		 ...
		 <div class="apparel_box">
			<ul class="login">
				...
				<li class="wish"><a href="index.jsp">Log out</a></li>
				<div class='clearfix'></div>
		    </ul>
		    <div class="cart_bg">
			  <ul class="cart">
				<i class="cart_icon"></i><p class="cart_desc">$0.00<br><span class="yellow">0 items</span></p>
			    <div class='clearfix'></div>
			  </ul>

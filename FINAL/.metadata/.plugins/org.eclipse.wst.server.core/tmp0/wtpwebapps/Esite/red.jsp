		...
		<div class="container">
			<div class="row">
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.jsp">
									<img class="etalage_thumb_image" src="images/pic12.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="images/pic12.jpg" class="img-responsive" />
								</a>
							</li>
						</ul>
					<!-- end product_slider -->
			  ...
			  <form action="AddtoCart" method="post">
				<h1>Lorel Ipsum Red</h1>
				<input type="hidden" name="Lorel Ipsum Red">
				<ul class="rating">

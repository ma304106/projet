		  ...
		  <div class="register">
		  	  <form action="paiement" method="post"> 
				 <div class="register-top-grid">
					<h3>Paiement Infos</h3>
					 <div>
						<span>Shipping Address<label>*</label></span>
						<input type="text" name="shipaddr"> 
					 </div>
					 <div>
						<span>Bills Address<label>*</label></span>
						<input type="text" name="billaddr"> 
					 </div>
					 <div>
						 <span>Shipping Town<label>*</label></span>
						 <input type="text" name="shipville"> 
					 </div>
					  <div>
						<span>Bill Town<label>*</label></span>
						<input type="text" name="billville"> 
					 </div>
					  <div>
						<span>Shipping Postal code<label>*</label></span>
						<input type="text"name="shipcp"> 
					 </div>
					  <div>
						<span>Bill Postal Code<label>*</label></span>
						<input type="text" name="billcp"> 
					 </div>
					 <div>
						<span>Paimenet Type<label>*</label></span> 
							<img src="https://www.paypal.com/fr_XC/i/logo/PayPal_mark_37x23.gif" align="left" style="margin-right:7px;"><span style="font-size:11px; font-family: Arial, Verdana;">Le réflexe sécurité.</span>
				...
				<div class="register-but">	   
					   <input type="submit" value="Proceed" class="cbp-vm-icon cbp-vm-add">
					   <div class="clearfix"> </div>
				   </form>
				</div>
		   </div>

...
<html>
<head>
<title>Surfhouse Bootstarp Website Template | Checkout ::
	w3layouts</title>
		...
		<div class="container">
			<div class="register">
				...
				<form action="deletePanier" method="post">
					<input type="submit" value="Clear" class="cbp-vm-icon cbp-vm-add">
				</form>
				<%}%>
			</div>
		</div>
	...
	<div class="container">
		<div class="brands">
			<ul class="brand_icons">
				...
				<li class="last"><img src='images/icon7.jpg'
	...
	<div class="footer">
		<div class="container">
			...
			<div class="footer-grid footer-grid_last">
				...
				<p class="email">
					Email: &nbsp;&nbsp;&nbsp;<span>info(at)Surfhouse.com</span>
				</p>
			</div>
			<div class="clearfix"></div>
		</div>

				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.jsp">
									<img class="etalage_thumb_image" src="images/pic11.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="images/pic11.jpg" class="img-responsive" />
								</a>
							</li>
						</ul>
					<!-- end product_slider -->
